...
namespace Microsoft.DotNet.Cli.Build
{
    public class Monikers
    {
        ...
        public const string SharedFxBrandName = "Microsoft .NET Core 1.1.4 - Runtime";
        public const string SharedHostBrandName = "Microsoft .NET Core 1.1.4 - Host";
        public const string HostFxrBrandName = "Microsoft .NET Core 1.1.4 - Host FX Resolver";
