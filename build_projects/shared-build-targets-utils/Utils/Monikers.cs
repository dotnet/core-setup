...
namespace Microsoft.DotNet.Cli.Build
{
    public class Monikers
    {
        ...
        public const string SharedFxBrandName = "Microsoft .NET Core 1.1.9 - Runtime";
        public const string SharedHostBrandName = "Microsoft .NET Core 1.1.9 - Host";
        public const string HostFxrBrandName = "Microsoft .NET Core 1.1.9 - Host FX Resolver";
        ...
        public static string GetProductMoniker(BuildTargetContext c, string artifactPrefix, string version)
        {
            ...
            if (rid == "ubuntu.16.04-x64" || rid == "ubuntu.16.10-x64" || rid == "ubuntu.18.04-x64" || rid == "fedora.23-x64" || rid == "fedora.24-x64" ||  rid == "fedora.27-x64" || rid == "opensuse.13.2-x64" || rid == "opensuse.42.1-x64" || rid == "opensuse.42.3-x64")
            {
