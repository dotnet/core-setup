...
namespace Microsoft.DotNet.Cli.Build
{
    public class Monikers
    {
        ...
        public const string SharedFxBrandName = "Microsoft .NET Core 1.1.3 - Runtime";
        public const string SharedHostBrandName = "Microsoft .NET Core 1.1.3 - Host";
        public const string HostFxrBrandName = "Microsoft .NET Core 1.1.3 - Host FX Resolver";
