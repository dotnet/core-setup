...
namespace Microsoft.DotNet.Cli.Build
{
    public class Monikers
    {
        ...
        public const string SharedFxBrandName = "Microsoft .NET Core 1.0.7 - Runtime";
        public const string SharedHostBrandName = "Microsoft .NET Core 1.0.7 - Host";
        public const string HostFxrBrandName = "Microsoft .NET Core 1.0.7 - Host FX Resolver";
