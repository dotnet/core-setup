...
namespace Microsoft.DotNet.Cli.Build
{
    public class Monikers
    {
        ...
        public const string SharedFxBrandName = "Microsoft .NET Core 1.0.6 - Runtime";
        public const string SharedHostBrandName = "Microsoft .NET Core 1.0.6 - Host";
        public const string HostFxrBrandName = "Microsoft .NET Core 1.0.6 - Host FX Resolver";
