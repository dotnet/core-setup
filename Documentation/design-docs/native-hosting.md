...
It is allowed to call the returned runtime helper many times for different assemblies or just different methods from the same assembly. It is not required to get the helper every time.
