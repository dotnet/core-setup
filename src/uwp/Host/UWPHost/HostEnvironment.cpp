...
HRESULT HostEnvironment::Initialize()
{
    ...
    length = 0;
    rc = GetPackageInfo(packageInfoReference, PACKAGE_FILTER_DIRECT|PACKAGE_FILTER_OPTIONAL, &length, NULL, &m_dependentPackagesCount);
    ...
    rc = GetPackageInfo(packageInfoReference, PACKAGE_FILTER_DIRECT|PACKAGE_FILTER_OPTIONAL, &length, buffer, &m_dependentPackagesCount);
    IfFailWin32Go(rc);
