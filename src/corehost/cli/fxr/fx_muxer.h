...
private:
    ...
    static fx_ver_t resolve_framework_version(const std::vector<fx_ver_t>& version_list, const pal::string_t& fx_ver, const fx_ver_t& specified, const bool& patch_roll_fwd, const enum roll_fwd_on_no_candidate_fx_option& roll_fwd_on_no_candidate_fx);
