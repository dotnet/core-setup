...
if /i [%1] == [comhostver]  (set __ComHostVersion=%2&&shift&&shift&goto Arg_Loop)
...
echo Calling "%__nativeWindowsDir%\gen-buildsys-win.bat %~dp0 "%__VSVersion%" %__BuildArch% %__CommitSha% %__HostVersion% %__AppHostVersion% %__ComHostVersion% %__HostResolverVersion% %__HostPolicyVersion%"
pushd "%__IntermediatesDir%"
call "%__nativeWindowsDir%\gen-buildsys-win.bat" %~dp0 "%__VSVersion%" %__BuildArch% %__CommitSha% %__HostVersion% %__AppHostVersion% %__ComHostVersion% %__HostResolverVersion% %__HostPolicyVersion% %__PortableBuild%
popd
