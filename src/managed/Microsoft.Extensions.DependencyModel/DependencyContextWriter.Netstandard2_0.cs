...
namespace Microsoft.Extensions.DependencyModel
{
    public class DependencyContextWriter
    {
        ...
        private void WriteRuntimeGraph(DependencyContext context, ref Utf8JsonWriter jsonWriter)
        {
        ...
        private void WriteCompilationOptions(CompilationOptions compilationOptions, ref Utf8JsonWriter jsonWriter)
        {
        ...
        private void AddStringPropertyIfNotNull(string name, string value, ref Utf8JsonWriter jsonWriter)
        {
            if (value != null)
            {
        ...
        private void WriteTargets(DependencyContext context, ref Utf8JsonWriter jsonWriter)
        {
        ...
        private void WritePortableTarget(string key, IReadOnlyList<RuntimeLibrary> runtimeLibraries, IReadOnlyList<CompilationLibrary> compilationLibraries, ref Utf8JsonWriter jsonWriter)
        {
        ...
        private void AddCompilationAssemblies(IEnumerable<string> compilationAssemblies, ref Utf8JsonWriter jsonWriter)
        {
        ...
        private void AddAssets(string key, RuntimeAssetGroup group, ref Utf8JsonWriter jsonWriter)
        {
        ...
        private void AddDependencies(IEnumerable<Dependency> dependencies, ref Utf8JsonWriter jsonWriter)
        {
            if (!dependencies.Any())
            {
                return;
        ...
        private void AddResourceAssemblies(IEnumerable<ResourceAssembly> resourceAssemblies, ref Utf8JsonWriter jsonWriter)
        {
        ...
        private void WriteTargetLibrary(string key, Library library, ref Utf8JsonWriter jsonWriter)
        {
        ...
        private void WritePortableTargetLibrary(string key, RuntimeLibrary runtimeLibrary, CompilationLibrary compilationLibrary, ref Utf8JsonWriter jsonWriter)
        {
            jsonWriter.WriteStartObject(key);
        ...
        private bool AddRuntimeSpecificAssetGroups(string assetType, IEnumerable<RuntimeAssetGroup> assetGroups, bool wroteObjectStart, ref Utf8JsonWriter jsonWriter)
        {
        ...
        private void AddRuntimeSpecificAssets(IEnumerable<RuntimeFile> assets, string runtime, string assetType, ref Utf8JsonWriter jsonWriter)
        {
        ...
        private void WriteAssetList(string key, IEnumerable<string> assetPaths, ref Utf8JsonWriter jsonWriter)
        {
        ...
        private void WriteAssetList(string key, IEnumerable<RuntimeFile> runtimeFiles, ref Utf8JsonWriter jsonWriter)
        {
            jsonWriter.WriteStartObject(key, escape: false);
        ...
        private void WriteLibraries(DependencyContext context, ref Utf8JsonWriter jsonWriter)
        {
        ...
        private void WriteLibrary(string key, Library library, ref Utf8JsonWriter jsonWriter)
        {
            jsonWriter.WriteStartObject(key);
